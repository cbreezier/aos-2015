 ...
 * @return 0 on success
 */
int usr_map_page(seL4_CPtr frame_cap, seL4_ARM_PageDirectory pd, seL4_Word vaddr, 
...
void* do_map_device(void* paddr, int size, seL4_CPtr page_directory, void* vaddr);
